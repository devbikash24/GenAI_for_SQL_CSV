...
class ProcessFiles:
    ...
    def __init__(self, files_dir: List, chatbot: List) -> None:
        ...
        """
        self.loading_conf = LoadConfiguration()

        self.files_dir = files_dir
        self.chatbot = chatbot
        db_path = self.loading_conf.uploaded_files_sqldb_directory
    ...
    def _process_uploaded_files(self) -> Tuple:
        ...
        self.chatbot.append(
            {'input':'','bot':'Uploaded files are ready. Please ask your question'})
        return "", self.chatbot
